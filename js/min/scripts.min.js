let API_BASE_URL="http://localhost:3001/api",scheduleData=[],sportsData=[];async function fetchFromAPI(t){try{var e=await fetch(""+API_BASE_URL+t);if(e.ok)return await e.json();throw new Error("HTTP "+e.status)}catch(e){return console.warn(`API call failed for ${t}:`,e.message),null}}async function loadScheduleData(){var e=await fetchFromAPI("/public/schedule");scheduleData=e||getMockScheduleData()}async function loadSportsData(){var e=await fetchFromAPI("/public/sports");sportsData=e||getMockSportsData()}function getMockScheduleData(){return[{day_of_week:"Måndag",start_time:"18:00",end_time:"19:00",sport_name:"Brottning",age_group:"6-13 år"},{day_of_week:"Måndag",start_time:"19:00",end_time:"21:00",sport_name:"Brottning",age_group:"14+"},{day_of_week:"Tisdag",start_time:"17:30",end_time:"18:30",sport_name:"Girls Only",age_group:"7-13 år"},{day_of_week:"Tisdag",start_time:"18:30",end_time:"19:45",sport_name:"Girls Only",age_group:"13+"},{day_of_week:"Onsdag",start_time:"18:00",end_time:"19:00",sport_name:"Brottning",age_group:"6-13 år"},{day_of_week:"Onsdag",start_time:"19:00",end_time:"21:00",sport_name:"Brottning",age_group:"14+"},{day_of_week:"Torsdag",start_time:"17:30",end_time:"18:30",sport_name:"Girls Only",age_group:"7-13 år"},{day_of_week:"Torsdag",start_time:"18:30",end_time:"19:45",sport_name:"Girls Only",age_group:"13+"},{day_of_week:"Fredag",start_time:"18:00",end_time:"20:00",sport_name:"Wresfit",age_group:"Alla åldrar"},{day_of_week:"Söndag",start_time:"12:00",end_time:"13:00",sport_name:"Brottning",age_group:"6-13 år"},{day_of_week:"Söndag",start_time:"13:00",end_time:"14:00",sport_name:"Brottning",age_group:"14+"}]}function getMockSportsData(){return[{name:"Brottning",description:"Greco-Roman och Freestyle brottning",age_groups:["Barn","Ungdom","Vuxna"]},{name:"Wresfit",description:"Funktionell styrketräning",age_groups:["Ungdom","Vuxna"]},{name:"Girls Only",description:"Boxning för tjejer",age_groups:["Ungdom","Vuxna"]}]}function populateSportsGrid(){let a=document.getElementById("sports-grid");a&&(a.innerHTML="",sportsData&&0!==sportsData.length?sportsData.forEach(e=>{var t=document.createElement("div");t.className="sport-card";let r="images/placeholder.jpg";e.name.toLowerCase().includes("brottning")?r="images/brottning.jpg":e.name.toLowerCase().includes("wresfit")?r="images/Wresfit.jpg":e.name.toLowerCase().includes("girls only")&&(r="images/girlsonly.jpeg"),t.innerHTML=`
      <div class="sport-image">
        <img src="${r}" alt="${e.name} logo" loading="lazy">
      </div>
      <div class="sport-content">
        <h3 class="sport-title">${e.name}</h3>
        <p>${e.description}</p>
        <div class="age-groups">
          <small>Åldersgrupper: ${e.age_groups&&Array.isArray(e.age_groups)?e.age_groups.join(", "):"Alla åldrar"}</small>
        </div>
      </div>
    `,a.appendChild(t)}):a.innerHTML="<p>Inga sporter tillgängliga för tillfället.</p>")}function populateWeeklyScheduleCards(e=null){var t=document.getElementById("weekly-schedule-cards"),r=(t.innerHTML="",scheduleData.map(e=>({day:e.day_of_week,time:e.start_time+"-"+e.end_time,activity:e.sport_name,level:e.age_group})));let a=r,n=(e&&"all"!==e&&("brottning-barn"===e?a=r.filter(e=>"Brottning"===e.activity&&"6-13 år"===e.level):"brottning-vuxna"===e?a=r.filter(e=>"Brottning"===e.activity&&"14+"===e.level):"girls-only"===e?a=r.filter(e=>"Girls Only"===e.activity):"girls-only-7-13"===e?a=r.filter(e=>"Girls Only"===e.activity&&"7-13 år"===e.level):"girls-only-13"===e?a=r.filter(e=>"Girls Only"===e.activity&&"13+"===e.level):"wresfit"===e&&(a=r.filter(e=>"Wresfit"===e.activity))),{});a.forEach(e=>{n[e.day]||(n[e.day]=[]),n[e.day].push(e)});var i,e=(new Date).toLocaleDateString("sv-SE",{weekday:"long"}),l=e.charAt(0).toUpperCase()+e.slice(1);for(i in n){let o=document.createElement("div");o.className="day-container "+(i===l?"today":"");var s=document.createElement("h3");s.className="day-header",s.textContent=i,o.appendChild(s),n[i].forEach(e=>{var t=document.createElement("div"),r=(t.className=`session-card ${getActivityClass(e.activity)} `+getLevelClass(e.level),t.setAttribute("data-filter",getFilterKey(e.activity,e.level)),document.createElement("div")),a=(r.className="session-icon",r.innerHTML=getActivityIcon(e.activity,e.level),document.createElement("div")),n=(a.className="session-content",document.createElement("div")),i=(n.className="session-time",n.textContent=e.time,document.createElement("div")),l=(i.className="session-activity",i.textContent=e.activity,document.createElement("div"));l.className="session-level",l.textContent=e.level,a.appendChild(n),a.appendChild(i),a.appendChild(l),t.appendChild(r),t.appendChild(a),o.appendChild(t)}),t.appendChild(o)}0===Object.keys(n).length&&((r=document.createElement("div")).className="no-sessions",r.textContent="Inga träningar hittades för denna filtrering.",t.appendChild(r))}function getFilterKey(e,t){return"Brottning"===e?"6-13 år"===t?"brottning-barn":"brottning-vuxna":"Girls Only"===e?"7-13 år"===t?"girls-only-7-13":"13+"===t?"girls-only-13":"girls-only":"Wresfit"===e?"wresfit":""}function filterSessions(r){document.querySelectorAll(".session-card").forEach(e=>{var t=e.getAttribute("data-filter");e.style.display="all"===r||t===r?"flex":"none"})}function getActivityClass(e){switch(e){case"Brottning":return"brottning";case"Wresfit":return"wresfit";case"Girls Only":return"girls-only";default:return""}}function getLevelClass(e){return"6-13 år"===e||"7-13 år"===e?"barn":"14+"===e||"13+"===e?"vuxna":""}function getActivityIcon(e,t){switch(e){case"Brottning":return`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg>`;default:return""}}function toggleMenu(){var e=document.querySelector(".nav-links"),t=document.querySelector(".hamburger"),r=document.querySelector(".menu-overlay"),e=e.classList.toggle("active");t.classList.toggle("active"),r.classList.toggle("active"),t.setAttribute("aria-expanded",e)}function bookSession(e,t,r){alert(`Bokning för ${r} ${e} ${t} har lagts till. (Funktionalitet kommer att implementeras med backend)`)}function handleLoginClick(){var e=localStorage.getItem("token"),t=JSON.parse(localStorage.getItem("user")||"null");e&&t&&"admin"===t.role?window.location.href="admin-dashboard.html":window.location.href="admin.html"}document.addEventListener("keydown",function(e){var t,r;"Escape"===e.key&&(e=document.querySelector(".nav-links"),t=document.querySelector(".hamburger"),r=document.querySelector(".menu-overlay"),e&&e.classList.remove("active"),t&&(t.classList.remove("active"),t.setAttribute("aria-expanded","false")),r)&&r.classList.remove("active")}),document.addEventListener("DOMContentLoaded",async function(){await loadScheduleData(),await loadSportsData(),populateSportsGrid(),document.getElementById("weekly-schedule-cards")&&populateWeeklyScheduleCards(new URLSearchParams(window.location.search).get("sport")),document.querySelectorAll(".nav-links a").forEach(e=>{e.addEventListener("click",()=>{document.querySelector(".nav-links").classList.remove("active"),document.querySelector(".hamburger").classList.remove("active"),document.querySelector(".menu-overlay").classList.remove("active"),document.querySelector(".hamburger").setAttribute("aria-expanded","false")})}),document.querySelectorAll(".filter-btn").forEach(e=>{e.addEventListener("click",function(){console.log("Filter button clicked:",this.getAttribute("data-filter")),document.querySelectorAll(".filter-btn").forEach(e=>e.classList.remove("active")),this.classList.add("active"),populateWeeklyScheduleCards(this.getAttribute("data-filter"))})})});